...
#include "../components/cmp_pause_button.h"
#include <random>
#include <chrono>
...
shared_ptr<PopupComponent> popup;
...
void LevelScene::Load() {
    ...
    popup = std::make_unique<PopupComponent>(
    ...
    auto pauseButton = makeEntity()->addComponent<PauseButton>(
